...
const styles=StyleSheet.create({accent:{color:colors.coral},subtitle:{marginTop:-spacing.sm,color:colors.muted,fontSize:14,lineHeight:20},grid:{flexDirection:'row',flexWrap:'wrap',gap:10},card:{width:'48.4%',height:212,padding:12,overflow:'hidden',borderWidth:1.5,borderRadius:radii.medium,backgroundColor:'#FFFFFF'},cardHeader:{minHeight:42,paddingRight:22,flexDirection:'row',alignItems:'center',gap:8},icon:{width:38,height:38,borderRadius:12,alignItems:'center',justifyContent:'center',flexShrink:0},title:{flex:1,color:colors.charcoal,...typography.label,fontSize:15,lineHeight:17},detail:{minHeight:30,marginTop:5,color:colors.muted,fontSize:10,lineHeight:14},foodImage:{width:'100%',height:104,marginTop:2,alignSelf:'center'},emptyVisual:{width:'100%',height:104,marginTop:2,borderRadius:14,alignItems:'center',justifyContent:'center'},check:{position:'absolute',right:8,top:8,zIndex:4,backgroundColor:'#FFFFFF',borderRadius:12},mascotStage:{height:242,marginTop:-6,alignItems:'center',justifyContent:'flex-end'},mascot:{width:194,height:238}});
