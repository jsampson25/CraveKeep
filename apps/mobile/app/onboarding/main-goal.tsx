...
import healthyFood from '../../assets/onboarding/preferences/pref-0.webp';
import mealPrepFood from '../../assets/onboarding/preferences/pref-2.webp';
import weightFood from '../../assets/onboarding/preferences/pref-1.webp';
import proteinFood from '../../assets/onboarding/preferences/pref-5.webp';
...
const styles=StyleSheet.create({accent:{color:colors.coral},subtitle:{marginTop:-spacing.sm,color:colors.muted,fontSize:14,lineHeight:20},grid:{flexDirection:'row',flexWrap:'wrap',gap:10},card:{width:'48.4%',minHeight:152,padding:13,justifyContent:'flex-end',overflow:'hidden',borderWidth:1.5,borderRadius:radii.medium,backgroundColor:'#FFFFFF'},cardTop:{position:'absolute',left:13,right:13,top:13,flexDirection:'row',alignItems:'center',justifyContent:'space-between',zIndex:2},icon:{width:38,height:38,borderRadius:12,alignItems:'center',justifyContent:'center'},title:{maxWidth:'65%',color:colors.charcoal,...typography.label,fontSize:14,zIndex:2},detail:{maxWidth:'62%',marginTop:4,color:colors.muted,fontSize:10,lineHeight:14,zIndex:2},foodImage:{position:'absolute',right:5,bottom:5,width:70,height:70}});
