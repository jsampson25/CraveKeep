...
const styles=StyleSheet.create({accent:{color:colors.coral},subtitle:{marginTop:-spacing.sm,color:colors.muted,fontSize:14},grid:{flexDirection:'row',flexWrap:'wrap',gap:9},card:{width:'48.5%',minHeight:104,padding:10,justifyContent:'flex-end',borderWidth:1,borderColor:colors.line,borderRadius:radii.medium,backgroundColor:'#FFFFFF',overflow:'hidden'},selected:{borderColor:colors.herb,backgroundColor:colors.herbSoft},icon:{position:'absolute',left:10,top:10,zIndex:2},photo:{position:'absolute',right:7,bottom:7,width:70,height:70},title:{maxWidth:'58%',color:colors.charcoal,...typography.label,fontSize:12,zIndex:2},check:{position:'absolute',right:7,top:7,zIndex:3,backgroundColor:'#FFFFFF',borderRadius:10},anything:{minHeight:52,paddingHorizontal:13,flexDirection:'row',alignItems:'center',gap:9,borderWidth:1,borderColor:colors.line,borderRadius:radii.small,backgroundColor:'#FFFFFF'},anythingText:{flex:1,color:colors.charcoal,fontWeight:'700',fontSize:13},notice:{padding:13,flexDirection:'row',alignItems:'center',gap:10,borderWidth:1,borderColor:'#E8C697',borderRadius:radii.small,backgroundColor:'#FFF8EE'},noticeText:{flex:1,color:colors.charcoal,fontSize:12,lineHeight:17}});
