...
const styles=StyleSheet.create({
 ...
 backdrop:{flex:1,justifyContent:'flex-end',backgroundColor:'rgba(12,26,52,.35)'},modal:{backgroundColor:'#FFF',borderTopLeftRadius:24,borderTopRightRadius:24,padding:20,gap:16},modalHead:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},modalTitle:{color:colors.charcoal,fontSize:20,fontWeight:'900'},modalSub:{marginTop:2,color:colors.muted,fontSize:13},close:{width:38,height:38,borderRadius:19,borderWidth:1,borderColor:colors.line,alignItems:'center',justifyContent:'center'},wheels:{flexDirection:'row',gap:8},monthWheel:{flex:1.8},wheelCol:{flex:1},wheelLabel:{marginBottom:6,color:colors.muted,fontSize:11,fontWeight:'800',textAlign:'center'},wheel:{height:184,overflow:'hidden',borderRadius:12,backgroundColor:'#FAF9F7'},wheelSelected:{position:'absolute',zIndex:0,top:70,left:5,right:5,height:46,borderRadius:10,borderWidth:1,borderColor:colors.coral,backgroundColor:'rgba(255,240,237,0.55)'},wheelRow:{height:46,alignItems:'center',justifyContent:'center',zIndex:1},wheelText:{color:colors.charcoal,fontSize:14,fontWeight:'700'}
});
