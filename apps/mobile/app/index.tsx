...
const WELCOME_KEY = 'cravekeep.welcome.v5';
...
const styles = StyleSheet.create({ screen: { flex: 1, backgroundColor: colors.paper, alignItems: 'center', justifyContent: 'center' }, logoStage: { position: 'absolute', width: 300, height: 286, alignItems: 'center', justifyContent: 'center', zIndex: 3 }, final: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, paddingHorizontal: spacing.lg, paddingTop: 170, paddingBottom: 36 }, art: { flex: 1, minHeight: 300, position: 'relative' }, food: { position: 'absolute', width: '100%', height: '100%' }, outline: { opacity: 0.42 }, copy: { gap: spacing.lg }, title: { color: colors.charcoal, fontFamily: 'Georgia', fontSize: 38, lineHeight: 43, fontWeight: '700', letterSpacing: -1 }, button: { minHeight: 58, borderRadius: radii.medium, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.coral }, pressed: { opacity: 0.8 }, buttonText: { color: colors.white, fontSize: 18, fontWeight: '800' } });
