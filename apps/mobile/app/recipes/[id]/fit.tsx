...
const styles = StyleSheet.create({ content: { padding: spacing.lg, gap: spacing.md, paddingBottom: 60 }, center: { padding: spacing.lg, justifyContent: 'center', gap: spacing.md }, header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.sm }, back: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.paperRaised }, estimate: { color: colors.herb, fontWeight: '800', fontSize: 12 }, kicker: { color: colors.coralDark, fontWeight: '900', letterSpacing: 1.2 }, body: { color: colors.muted, lineHeight: 21 }, modes: { gap: spacing.sm }, mode: { padding: spacing.md, borderWidth: 1, borderColor: colors.line, borderRadius: radii.medium, backgroundColor: colors.paperRaised, gap: spacing.xs }, modeActive: { borderColor: colors.coral, backgroundColor: '#FFF0ED' }, modeTitle: { color: colors.charcoal, fontWeight: '900' }, modeTitleActive: { color: colors.coralDark }, targets: { gap: spacing.sm }, result: { gap: spacing.sm, backgroundColor: colors.herbSoft }, cardTitle: { color: colors.charcoal, fontSize: 17, fontWeight: '900' }, serving: { color: colors.herb, fontSize: 24, fontWeight: '900' }, metrics: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }, metric: { color: colors.charcoal, fontWeight: '800', backgroundColor: colors.paperRaised, padding: spacing.sm, borderRadius: radii.small }, subheading: { color: colors.charcoal, fontWeight: '900', marginTop: spacing.sm }, remaining: { color: colors.herb, fontWeight: '700' }, over: { color: colors.coralDark, fontWeight: '800' }, tradeoff: { color: colors.muted, lineHeight: 20 }, prompt: { color: colors.muted, textAlign: 'center', padding: spacing.md } });
