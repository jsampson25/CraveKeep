...
export default function RecipeDetailScreen() {
  ...
  return <Screen><ScrollView contentContainerStyle={styles.content}>
    ...
    {recipe.source.mediaType === 'video' || recipe.source.mediaType === 'social' ? <Button label="Watch source video" variant="secondary" onPress={() => router.push(`/recipes/${recipe.id}/video` as never)} /> : null}
