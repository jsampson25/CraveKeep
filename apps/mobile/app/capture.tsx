...
const paths = [
  ...
  { icon: 'link-outline', title: 'Paste a link', detail: 'From a website or any recipe page', ready: false },
  ...
  { icon: 'create-outline', title: 'Create it myself', detail: 'Write your own recipe from scratch', ready: true }
] as const;
