...
export default function CaptureScreen() {
  return <Screen><ScrollView contentContainerStyle={styles.content}>
    ...
    <Card style={styles.hero}><View style={styles.heroCopy}><Eyebrow>CAPTURE STUDIO</Eyebrow><Title>Bring recipes in from anywhere.</Title><Text style={styles.intro}>Scan, paste, upload, or create. CraveKeep will turn it into a recipe you can actually use.</Text></View><MotionSlot name='onboarding-recipe-card' size={100} accessibilityLabel='Recipe capture animation' /></Card><Text style={styles.intro}>Choose the source you have. Your source and unfinished work will stay attached.</Text>
    ...
    <Button label="Share something with Community" variant="secondary" onPress={() => router.push('/community/share')} />
