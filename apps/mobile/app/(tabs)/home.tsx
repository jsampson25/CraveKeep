...
const styles = StyleSheet.create({
  ...
  dinnerCard: { padding: spacing.md, gap: spacing.sm, overflow: 'hidden', borderRadius: radii.large, backgroundColor: '#FFF0C8' }, dinnerBody: { minHeight: 154, flexDirection: 'row', gap: spacing.md }, dinnerArt: { width: '54%', height: 170 }, dinnerCopy: { flex: 1, justifyContent: 'center' }, dinnerTitle: { color: colors.charcoal, ...typography.title, fontSize: 21 }, dinnerMeta: { marginTop: 8, color: colors.muted, fontSize: 11 }, cookButton: { minHeight: 40, marginTop: 12, paddingHorizontal: 14, alignItems: 'center', justifyContent: 'center', borderRadius: radii.small, backgroundColor: colors.coral }, cookButtonText: { color: colors.white, fontWeight: '900' },
  ...
  recipeCarousel: { gap: spacing.sm, paddingRight: spacing.md }, recipeCard: { width: 156, minHeight: 174, padding: 8, borderWidth: 1, borderColor: colors.line, borderRadius: radii.medium, backgroundColor: colors.paperRaised }, recipeImage: { height: 94, overflow: 'hidden', borderRadius: radii.small }, recipeArtFill: { width: '100%', height: '100%' }, favorite: { position: 'absolute', right: 5, top: 5, width: 28, height: 28, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(20,33,61,0.55)' }, recipeName: { minHeight: 34, marginTop: 7, color: colors.charcoal, fontSize: 12, fontWeight: '900' }, recipeMeta: { color: colors.muted, fontSize: 9 }, recipeBadge: { marginBottom: 6, paddingVertical: 4, borderRadius: 6, color: colors.white, fontSize: 9, fontWeight: '900', textAlign: 'center' }, greenBadge: { backgroundColor: colors.herb }, blueBadge: { backgroundColor: '#3478C5' },
