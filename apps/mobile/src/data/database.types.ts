...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      recipes: {
        Row: { cook_minutes: number; created_at: string; description: string; favorite: boolean; id: string; original_recipe_id: string | null; owner_id: string; prep_minutes: number; privacy: string; servings: number; source_captured_at: string; source_creator: string | null; source_kind: Database['public']['Enums']['recipe_source_kind']; source_label: string; source_url: string | null; title: string; updated_at: string; version_number: number };
        Insert: { cook_minutes?: number; created_at?: string; description?: string; favorite?: boolean; id?: string; original_recipe_id?: string | null; owner_id: string; prep_minutes?: number; privacy?: string; servings?: number; source_captured_at?: string; source_creator?: string | null; source_kind: Database['public']['Enums']['recipe_source_kind']; source_label: string; source_url?: string | null; title: string; updated_at?: string; version_number?: number };
        Update: { cook_minutes?: number; created_at?: string; description?: string; favorite?: boolean; id?: string; original_recipe_id?: string | null; owner_id?: string; prep_minutes?: number; privacy?: string; servings?: number; source_captured_at?: string; source_creator?: string | null; source_kind?: Database['public']['Enums']['recipe_source_kind']; source_label?: string; source_url?: string | null; title?: string; updated_at?: string; version_number?: number };
