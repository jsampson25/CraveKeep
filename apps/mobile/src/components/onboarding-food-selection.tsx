...
const styles=StyleSheet.create({accent:{color:colors.coral},subtitle:{marginTop:-spacing.sm,color:colors.muted,fontSize:14,lineHeight:19},search:{minHeight:46,paddingHorizontal:12,flexDirection:'row',alignItems:'center',gap:8,borderWidth:1,borderColor:colors.line,borderRadius:radii.small,backgroundColor:'#FFFFFF'},searchInput:{flex:1,color:colors.charcoal,fontSize:14},section:{gap:7},sectionHeader:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},sectionTitle:{color:colors.charcoal,...typography.label,fontSize:14},count:{color:colors.coralDark,fontSize:10,fontWeight:'700'},grid:{flexDirection:'row',flexWrap:'wrap',gap:7},food:{width:'31.8%',minHeight:92,padding:6,alignItems:'center',justifyContent:'flex-end',overflow:'hidden',borderWidth:1,borderColor:colors.line,borderRadius:12,backgroundColor:'#FFFFFF'},foodActive:{borderColor:colors.herb,backgroundColor:colors.herbSoft},avoidActive:{borderColor:colors.coral,backgroundColor:'#FFF0ED'},foodPhoto:{width:'100%',height:60,borderRadius:8,marginBottom:5},photoFallback:{width:'100%',height:60,alignItems:'center',justifyContent:'center',borderRadius:8,marginBottom:5,backgroundColor:'#FAF5EF'},foodName:{maxWidth:'100%',color:colors.charcoal,fontSize:10,fontWeight:'700',textAlign:'center'},check:{position:'absolute',right:4,top:4,backgroundColor:'#FFFFFF',borderRadius:9},nothing:{minHeight:52,paddingHorizontal:13,flexDirection:'row',alignItems:'center',gap:9,borderWidth:1,borderColor:colors.line,borderRadius:radii.small,backgroundColor:'#FFFFFF'},nothingActive:{borderColor:colors.herb,backgroundColor:colors.herbSoft},nothingText:{color:colors.charcoal,fontWeight:'700'},empty:{color:colors.muted,textAlign:'center'}});
