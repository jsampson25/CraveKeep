...
type RecipeArtProps = { compact?: boolean; favorite?: boolean; imageUrl?: string; style?: ViewStyle };

export function RecipeArt({ compact = false, favorite = false, imageUrl, style }: RecipeArtProps) {
